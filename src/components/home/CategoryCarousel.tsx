...
export function CategoryCarousel({
  ...
  // Derive fade gradient from bg class
  const fadeFrom = bg === "bg-neutral-50" ? "from-neutral-50" : "from-white";

  return (
    <section className={`section-spacing ${bg}`}>
      <div className="container-luxury">
        ...
        <div className="relative -mx-4 sm:mx-0">
          {canScrollLeft && (
            <div className={`pointer-events-none absolute inset-y-0 left-0 z-10 hidden w-12 bg-gradient-to-r ${fadeFrom} to-transparent sm:block`} />
          )}
          {canScrollRight && (
            <div className={`pointer-events-none absolute inset-y-0 right-0 z-10 hidden w-12 bg-gradient-to-l ${fadeFrom} to-transparent sm:block`} />
          )}
