...
interface SunKissedCarouselProps {
  products: Product[];
}

export function SunKissedCarousel({ products }: SunKissedCarouselProps) {
    ...
    <section className="section-spacing bg-neutral-50">
      <div className="container-luxury">
        ...
        <div className="relative -mx-4 sm:mx-0">
          ...
          {canScrollLeft && (
            <div className="pointer-events-none absolute inset-y-0 left-0 z-10 hidden w-12 bg-gradient-to-r from-neutral-50 to-transparent sm:block" />
          )}
          {canScrollRight && (
            <div className="pointer-events-none absolute inset-y-0 right-0 z-10 hidden w-12 bg-gradient-to-l from-neutral-50 to-transparent sm:block" />
          )}
