...
const PRINCIPLES = [
  {
    ...
    description:
      <>Every purchase supports women&apos;s causes through our foundation, <a href="https://rehvampfoundation.org/" target="_blank" rel="noopener noreferrer" className="font-medium text-brand-purple hover:underline">RehVamp</a>.</>,
    icon: (
